...
class get_model(nn.Module):
    def __init__(self, angRes=5, scale_factor=4):
    ...
    def forward(self, lr, info=None):
        ...
        train_data = rearrange(lr, 'b c (a1 h) (a2 w) -> (b c) a1 a2 h w', a1=5, a2=5)
        ...
        full_up += train_data
        out = rearrange(full_up, 'b c (a1 a2) h w -> b c (a1 h) (a2 w)', a1=5, a2=5)
...
class get_loss(nn.Module):
    ...
    def forward(self, SR, HR, criterion_data=[]):
        ...
        gradient_loss = 0.8*self.gradient_loss(HR, SR)
