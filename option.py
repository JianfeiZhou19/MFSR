...
parser.add_argument('--model_name', type=str, default='exp9', help="model name")
parser.add_argument("--use_pre_ckpt", type=bool, default=True, help="use pre model ckpt")
parser.add_argument("--path_pre_pth", type=str, default='./log/SR_5x5_4x/ALL/LF_InterNet/checkpoints/LF_InterNet_5x5_4x_epoch_51_model.pth', help="path for pre model ckpt")
...
parser.add_argument('--path_for_train', type=str, default='/vepfs/Perception/Users/jianfei/self_exp/datasets/data_for_training/')
parser.add_argument('--path_for_test', type=str, default='/vepfs/Perception/Users/jianfei/self_exp/datasets/data_for_test/')
